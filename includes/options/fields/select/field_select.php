    ...
    class ReduxFramework_select {
        ...
        function render() {
            ...
            if (!empty($this->field['options'])) {
                ...
                if (!empty($this->field['width'])) {
                    ...
                    $width = ' style="width: 40%;background: url(http://wpml2.dev/wp-content/plugins/globus/flags/de.png) no-repeat 0 0;';
                }
                ...
                foreach ($this->field['options'] as $k => $v) {
                    ...
                    echo '<img src="" /><option class="globus-flag" style="background-image:url(http://wpml2.dev/wp-content/plugins/globus/flags/de.png);" value="' . $k . '"' . $selected . '>' . $v . '</option>';
                }//foreach
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
				...
				plugins_url( '/field_select.js', __FILE__ ),
            ...
            wp_enqueue_style(
				...
				plugins_url( '/field_select.css', __FILE__ ),
                time(),
                true
            );
        }   //function
