...
if (!class_exists('ReduxFramework_select_with_flag')) {
    class ReduxFramework_select_with_flag {
        ...
        function render() {
            ...
            if (!empty($this->field['options'])) {
                ...
                echo '<select ' . $multi . ' id="' . $this->field['id'] . '-select" data-placeholder="' . $placeholder . '" name="' . $this->field['name'] . '' . $nameBrackets . $this->field['name_suffix'] . '" class="redux-select-with-flag-item ' . $this->field['class'] . $sortable . '"' . $width . ' rows="6">';
                echo '<option></option>';
         ...
         */
        function enqueue() {
			//error_log(ReduxFramework::$_url . 'inc/fields/select/field_select.js');
            wp_enqueue_script(
                'field-select-js',
                #ReduxFramework::$_url . 'inc/fields/select/field_select.js',
				plugins_url( '/field_select_with_flag.js', __FILE__ ),
            ...
            wp_enqueue_style(
				...
				plugins_url( '/field_select_with_flag.css', __FILE__ ),
                time(),
                true
            );
        }   //function
