...
if ( ! class_exists( 'WPGlobus_Plugin_Install' ) ) : 
	...
	class WPGlobus_Plugin_Install {
		...
		public static function controller() {
			...
			if ( $_GET[ 'source' ] != 'WPGlobus' || $_GET[ 's' ] != 'WPGlobus' ) {
				return;
			}			
		...
		public static function filter__plugins_api_result( $res, $action, $args ) {
			...
			$paid_plugin->slug 				= $slug;
			$paid_plugin->short_description = 'With WPGlobus Plus, you will be able to hold incomplete translations as “drafts”, translate URLs (post/page “slugs”), customize the menu language switcher layout and more. See details in the description below.';
