...
class WPGlobus_aioseop {
	...
	function on_admin_footer() {
		...
		$fields['aiosp_title']['opts'] = array(
			...
			'count' => true,
			'size' => 60,
			'help_text' => 'A custom title that shows up in the title tag for this page.<br /><a href"http://semperplugins.com/sections/postpage-settings/" target="_blank">Click here for documentation on this setting</a>',
			'default' => '',
			'initial_options' => '', 
			'nowrap' => '',
			'label' => '',
