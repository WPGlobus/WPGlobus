...
class WPGlobus {
	...
	function on_wpseo_tab_content() {
		...
		<div id="wpglobus-wpseo-tabs"> 	<?php
			 ...
			 */ ?>
			<span id="wpglobus-wpseo-attr" data-ids="wpseosnippet,wpseosnippet_title,yoast_wpseo_focuskw,focuskwresults,yoast_wpseo_title,yoast_wpseo_metadesc,yoast_wpseo_metadesc-length"
