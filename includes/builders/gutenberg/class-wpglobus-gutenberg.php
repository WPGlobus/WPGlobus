...
class WPGlobus_Gutenberg extends WPGlobus_Builder {
	 ...
	 * @return string
	 */
	private function get_switcher_box() {
		...
		if ( false ) {
			ob_start();
			?>
			<div style="position:absolute;top:20px;left:10px;z-index:100;" class="wpglobus-gutenberg-selector-box">
				<a href="<?php echo str_replace('{{language}}', $this->language, $url); ?>" style="" class="wpglobus-gutenberg-selector" data-language="<?php echo $this->language; ?>">
					<img src="<?php echo WPGlobus::Config()->flags_url.WPGlobus::Config()->flag[$this->language]; ?>" />&nbsp;<?php echo WPGlobus::Config()->en_language_name[$this->language]; ?>
				</a>
