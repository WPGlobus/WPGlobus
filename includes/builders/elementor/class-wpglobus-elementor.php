...
if ( ! class_exists( 'WPGlobus_Elementor' ) ) :
	...
	class WPGlobus_Elementor extends WPGlobus_Builder {
		...
		public function __construct()  {
			 ...
			 *
			 * @see elementor\includes\editor.php
			 */			
			...
			if ( is_admin() ) {
				...
				/**
				 * @see elementor\core\base\document.php
				 */
		...
		public function on__elementor_footer() {
			...
			<div id="wpglobus-elementor-wrapper">
				<div class="elementor-panel-menu-item" id="wpglobus-elementor-panel-menu-item" style="cursor:auto;">
					...
					<div class="elementor-panel-menu-item-title" id="wpglobus-elementor-selector-box" style="padding-top:0;">
						<span id="wpglobus-elementor-selector-title" style="cursor:pointer;"><?php esc_html_e('WPGlobus languages', 'wpglobus'); ?></span>
